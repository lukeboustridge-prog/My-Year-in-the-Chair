// app/visits/page.tsx — client page with default export
'use client';
import React from "react";
import Modal from "../../components/Modal";
import { toDisplayDate } from "../../lib/date";
import { getVisits, createVisit, updateVisit, deleteVisit, type Visit, type Degree } from "../../lib/api";

const emptyVisit: Visit = { dateISO: '', lodgeName: '', lodgeNumber: '', eventType: '', grandLodgeVisit: false, notes: '' };
...
export default function VisitsPage() {
  ...
  async function saveVisit(e: React.FormEvent) {
    e.preventDefault();
    if (!editing || !editing.dateISO || !editing.eventType) {
        ...
        <form className="space-y-4" onSubmit={saveVisit}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <label className="label">
              ...
              <select className="input mt-1" value={editing?.eventType} onChange={e=>setEditing(v=>({...(v as Visit), eventType: e.target.value as Degree}))} required>
