/**
 * Full constants with ranks (prefix + post-nominals), helpers, regions, and work types.
 * This file restores the missing exports used by Profile: RANK_OPTIONS, RANK_META, deriveTitle.
 */
...
/**
 * Past Grand handling: converts post-nominals to P-variants when isPastGrand is true.
 */
...
// Regions (adjust as needed)
export const REGIONS = ["Northern","Central","Southern","Overseas"];

// Work types (Title Case labels, uppercase values)
