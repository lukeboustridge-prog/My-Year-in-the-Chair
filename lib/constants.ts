/**
 * Offices / Ranks (ascending) + Grand offices, with default prefixes and post-nominals.
 * You can extend or tweak abbreviations here as needed.
 */
...
/**
 * Prefix & post-nominals mapping.
 * Notes:
 *  - For "Grand Superintendent of Region", we store "G Supt" and you can append region name in UI.
 *  - "Grand Bible Bearer" listed as active until 24 Oct 2025 — kept for now.
 */
...
/**
 * Past Grand handling: if isPastGrand is true and the selected rank is a Grand office,
 * we generate common P-variants where they exist. Adjust to match your BoC if needed.
 */
...
// Regions kept if you want to display them alongside a Superintendent title.
export const REGIONS = ["Northern","Central","Southern","Overseas"];

// Work types (used in forms)
